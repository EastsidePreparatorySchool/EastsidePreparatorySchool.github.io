...
var vizChannels = {
    ...
    'SENSORARRAY.gc1': {name: 'GC1 (Whitmer, inside) (cps)', shortname: 'GC1 (W) inside', unit: 'cps', min: 0, max: 50, type: "discrete trailing", datatype: "numeric", graph: "yes", visible:true},
    'SENSORARRAY.lastByte': {name: 'GC1 last byte', shortname: 'GC1 lastByte', unit: '', min: 0, max: 20, type: "momentary", datatype: "numeric", graph: "yes", visible:true},
